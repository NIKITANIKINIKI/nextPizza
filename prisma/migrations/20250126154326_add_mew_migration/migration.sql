...
-- AddForeignKey
ALTER TABLE "ProductItems" ADD CONSTRAINT "ProductItems_productId_fkey" FOREIGN KEY ("productId") REFERENCES "Product"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "CartItem" ADD CONSTRAINT "CartItem_productItemId_fkey" FOREIGN KEY ("productItemId") REFERENCES "ProductItems"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
